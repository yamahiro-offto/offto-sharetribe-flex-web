...
import css from './LayoutDoubleColumn.css';
...
const prepareChildren = children => {
  ...
  React.Children.forEach(children, child => {
    if (child.type === LayoutWrapperTopbar) {
      ...
      throw new Error(
        `LayoutDoubleColumn has an unknown child.
...
const LayoutDoubleColumn = props => {
...
LayoutDoubleColumn.defaultProps = {
  className: null,
  rootClassName: null,
};
